...
export default function VehicleCardProfile({ vehicleId, vehiclename, description, cardImage, vehicletype, capacity }) {
  ...
  const handleNavigateToVehicle = (id) => {
    ...
    navigation.navigate(targetScreen, { screen: "VehicleDetail", params: { vehicleId: id } });
  };

  return (
    <View style={{ marginBottom: 0, borderRadius: vh(2), padding: vh(1) }}>
        ...
        <TouchableOpacity onPress={() => handleNavigateToVehicle(vehicleId)}>
          <View style={styles.cardContainer}>
            ...
            <View style={styles.textContainer}>
              <ParrotsStdText numberOfLines={1} style={styles.headerName}>{vehiclename}</ParrotsStdText>
              <View style={styles.pillRow}>
                ...
                <View style={[styles.pillView, { backgroundColor: "#F4F7FB" }]}>
                  <ParrotsStdText style={[styles.pillText, { color: "#4A5A6A" }]}>{capacity > 100 ? "100+" : capacity}</ParrotsStdText>
