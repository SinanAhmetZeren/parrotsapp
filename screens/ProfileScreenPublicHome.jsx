...
import VehicleListHome from "../components/VehicleListHome";
import VoyageListVerticalHome from "../components/VoyageListVerticalHome";
...
export default function ProfileScreenPublicHome({ navigation }) {
